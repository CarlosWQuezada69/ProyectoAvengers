        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_slider_items_users_created_by_user_id",
                        column: x => x.created_by_user_id,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    product_id = table.Column<Guid>(type: "uuid", nullable: false),
                    restriction_type = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_restrictions", x => x.id);
                    table.CheckConstraint("CK_product_restrictions_restriction_type", "restriction_type IN ('AGE_MIN', 'PURCHASE_LIMIT_USER', 'PURCHASE_LIMIT_ORDER', 'AVAILABILITY_WINDOW', 'GEOGRAPHIC', 'LIMITED_STOCK')");
                    table.ForeignKey(
                        name: "FK_product_restrictions_products_product_id",
                        column: x => x.product_id,
                        principalTable: "products",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    purchases = table.Column<int>(type: "integer", nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_stats_daily", x => x.id);
                    table.ForeignKey(
                        name: "FK_product_stats_daily_products_product_id",
                        column: x => x.product_id,
                        principalTable: "products",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_email_change_requests_token",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_product_restrictions_config_gin",
                table: "product_restrictions",
                column: "config")
                .Annotation("Npgsql:IndexMethod", "GIN");

            migrationBuilder.CreateIndex(
                name: "idx_product_restrictions_product",
                table: "product_restrictions",
                column: "product_id");

            migrationBuilder.CreateIndex(
                name: "IX_product_stats_daily_product_id_date",
                table: "product_stats_daily",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_slider_items_created_by_user_id",
                table: "slider_items",
                column: "created_by_user_id");
